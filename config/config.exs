...
config :rockelivery, RockeliveryWeb.Auth.Guardian,
  issuer: "rockelivery",
  secret_key: "qRHJ0scso1UYYvqwl7UwOZ0cUc0hNuwEuMbbgmsXONNLn/l9k3NleMuNoutvgiAW"
...
config :rockelivery, RockeliveryWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [view: RockeliveryWeb.ErrorView, accepts: ~w(html json), layout: false],
  pubsub_server: Rockelivery.PubSub,
  live_view: [signing_salt: "8/eTxMJO"]
